...
enum class UserErrorCode(
    ...
    EMAIL_VERIFY_FAIL(StatusCode.UNAUTHORIZED.code, "인증 코드가 일치하지 않습니다."),
    ALREADY_EXISTS_USER(StatusCode.BAD_REQUEST.code, "이미 가입한 유저입니다."),
    ...
    REFRESH_TOKEN_EXPIRED(StatusCode.BAD_REQUEST.code, "재발급 토큰이 만료되었습니다.");
